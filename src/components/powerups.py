...
class Mushroom(Powerup):
    ...
    def handle_state(self):
        if self.state == c.MSPAWN:
            self.Spawning()
        elif self.state == c.MSLIDE:
            self.Sliding()
...
class FireBall(pg.sprite.Sprite):
    ...
    def handle_state(self):
        if self.state == c.INAIR:
            self.animation()
        elif self.state == c.FBOUNCE:
            self.animation()
        elif self.state == c.FCOLLIDE:
            self.animation()
            
    def animation(self):
        if self.state == c.INAIR or self.state == c.FBOUNCE:
