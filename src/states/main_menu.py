...
class Menu(settings._State):
    ...
    def setup_players(self):
        ...
        dest = (220, 358)
        self.player.image, self.player.rect = self.get_image(
    ...
    def setup_background(self):
        ...
        self.image_dict = {}
        self.image_dict['GAME_NAME'] = self.get_image(
    ...
    def update(self, surface, keys, current_time):
        ...
        surface.blit(self.image_dict['GAME_NAME'][0],
                     self.image_dict['GAME_NAME'][1])
    ...
    def update_players(self, keys):
        ...
        if self.player.state == c.PLAYER1:
            self.player.rect.y = 358
            if keys[pg.K_DOWN]:
